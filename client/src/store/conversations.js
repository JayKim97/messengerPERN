...
const EDIT_CONVERSATION = "EDIT_CONVERSATION";
...
// update messages on conversation
...
export const updateOtherUserRead = (conversationId,senderId)=>{
  return {
